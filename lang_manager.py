    ...
    def __init__(self):
        ...
        self.translations = {
            "vi": {
                ...
                # Study mode texts
                "study_mode_title": "Chế Độ Học Tập",
                "question_label": "Câu Hỏi",
                "your_answer": "Câu Trả Lời Của Bạn:",
                "show_answer": "Hiện Đáp Án",
                "correct_answer": "Đáp Án Đúng",
                "how_did_you_do": "Bạn làm thế nào?",
                "correct": "Đúng",
                "need_practice": "Cần Luyện Tập",
                "progress": "Tiến Độ",
                "accuracy": "Độ Chính Xác",
                "total_cards": "Tổng Số Thẻ",
                "current_card": "Thẻ Hiện Tại",
                "completed": "hoàn thành",
                "cards_completed": "thẻ đã hoàn thành",
                "answer_placeholder": "Gõ câu trả lời của bạn ở đây...",
                "study_mode": "Chế Độ Học",
                "exit_study": "Thoát Học",
                "navigation": "Điều Hướng",
                "show_question": "Hiện Câu Hỏi",
                "show_answer_btn": "Hiện Đáp Án",
                # Beautiful UI texts
                "choose_input_method": "Chọn Phương Thức Nhập",
                "upload_your_files": "Tải Lên Files Của Bạn",
                "enter_your_content": "Nhập Nội dung Của Bạn",
                "flashcard_settings": "Cài Đặt Thẻ Ghi Nhớ",
                "generate_your_flashcards": "Tạo Thẻ Ghi Nhớ Của Bạn",
                "extracting_content": "Đang trích xuất nội dung...",
                "successfully_extracted": "Trích xuất thành công từ",
                "extracted_content_editable": "Nội Dung Đã Trích Xuất (Có Thể Chỉnh Sửa)",
                "review_edit_content": "Xem lại và chỉnh sửa nội dung đã trích xuất nếu cần",
                "error_extracting": "Lỗi khi trích xuất nội dung:",
                "save_flashcard_set": "Lưu Bộ Thẻ Ghi Nhớ",
                "current": "Hiện tại:",
                "edit_flashcard": "Chỉnh Sửa Thẻ Ghi Nhớ",
                "mode": "Chế Độ",
                "study": "Học",
                "review": "Ôn Tập",
                "library_statistics": "Thống Kê Thư Viện",
                "your_flashcard_sets": "Bộ Thẻ Ghi Nhớ Của Bạn",
                "sets": "bộ",
                "total_cards_text": "tổng số thẻ",
                "quick_load": "Tải Nhanh",
                "view": "Xem",
                "delete": "Xóa",
            },
            "en": {
                ...
                "generate_your_flashcards": "Generate Your Flashcards",
                "extracting_content": "Extracting content...",
                "successfully_extracted": "Successfully extracted from",
                "extracted_content_editable": "Extracted Content (Editable)",
                "review_edit_content": "Review and edit extracted content if needed",
                "error_extracting": "Error extracting content:",
                "save_flashcard_set": "Save Flashcard Set",
                "current": "Current:",
                ...
                "your_flashcard_sets": "Your Flashcard Sets",
                "sets": "sets",
                "total_cards_text": "total cards",
